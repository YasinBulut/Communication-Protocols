...
namespace CommProtocolApp.Entity
{
    ...
    public partial class DBCONNEntities : DbContext
    {
        public DBCONNEntities()
            : base("name=DBCONNEntities")
        {
        }
        ...
        public virtual DbSet<TBLMuh> TBLMuhSet { get; set; }
        public virtual DbSet<Tbl_Datax> Tbl_Datax { get; set; }
