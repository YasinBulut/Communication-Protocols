...
{
    public partial class DesDepartment : Form
    {
        public DesDepartment()
        {
            InitializeComponent();
        }
        DBCONNEntities db = new DBCONNEntities();
        private void DesDepartment_Load(object sender, EventArgs e)
        {
            db.TBLDep.Load();
            bindingSource1.DataSource = db.TBLDep.Local;
